...
class CustomGeneration(GenerationMixin):
    ...
    def __init__(self, model, tokenizer):
        # Call the constructor of the parent class (GenerationMixin)
    ...
    def generate_modified(
        ...
        **kwargs,
        ...
        """
        print("modified generate function")
        ...
        inputs_tensor, model_input_name, model_kwargs = self._prepare_model_inputs( #modify it 
