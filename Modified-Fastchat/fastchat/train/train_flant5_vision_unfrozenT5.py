...
from docvqa_llm_vision_T5unfrozen import DocVQALLM, smart_tokenizer_and_embedding_resize
...
class SupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        full_data_dict["images"] = self.load_image_embeds_batch(data_dict["embeds"],data_dict["documents"],data_dict["start_idx"],data_dict["end_idx"])
    ...
    def load_image_embeds_batch(self, embed_sources, documents, start_idx, end_idx, batch_size=10):
        embeddings = []
            ...
            while batch_start < num_indices:
                ...
                for idx in batch_indices:
                    ...
                    if embed_batch is None:
                        ...
                        embed_batch = torch.cat((embed_batch, embed), 1)
                
                embed_batches.append(embed_batch.cpu())
                batch_start += batch_size
            
            embed = torch.cat(embed_batches, 1)
