...
if __name__ == "__main__":
    ...
    model = DocVQALLM.from_pretrained("/home/aolivera/TFM-LLM/LLM/Modified-Fastchat/scripts/checkpoints/checkpoints_flant5_pretask_CLIP_T5w_new/checkpoint-30000",freeze_linear=True, vision_tower_type="CLIP",freeze_visionTower=True, freeze_llm=True)
